...
extern const unsigned char hell_song_pt3[];
extern const unsigned int hell_song_pt3_len;
extern const unsigned char cave_song_pt3[];
extern const unsigned int cave_song_pt3_len;
extern const unsigned char evilfight_song_pt3[];
extern const unsigned int evilfight_song_pt3_len;
extern const char abbye_sfx_afb[];
extern const unsigned int abbye_sfx_afb_len;
